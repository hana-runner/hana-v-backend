...
public class UserControllerTest extends RestDocsTest {
    ...
    @MethodInfo(name = "userJoinSuccessGET", description = "회원 가입 API 성공을 테스트합니다.")
    @Test
    public void testJoinUser() throws Exception {
        ...
        ResultActions result =
                mockMvc.perform(
                        get("/v1/api/users/")
                                .param("username", userJoinRequest.getUsername())
                                .param("name", userJoinRequest.getName())
                                .param("pw", userJoinRequest.getPw())
                                .param("email", userJoinRequest.getEmail())
                                .param("gender", String.valueOf(userJoinRequest.getGender())));
                        ...
                        document(
                                ...
                                resource(
                                        ResourceSnippetParameters.builder()
                                                ...
                                                .summary("유저 API")
                                                .description(
                                                        "유저 API 입니다. 요청 데이터를 받아 응답 데이터를 반환합니다. 0을 넣으면 Exception이 발생합니다.")
                                                .queryParameters(
                                                        ...
                                                        parameterWithName("name")
                                                                .description("이름")
                                                                .type(SimpleType.STRING),
                                                        parameterWithName("pw")
                                                                .description("비밀번호")
                                                                .type(SimpleType.STRING),
                                                        parameterWithName("email")
                                                                .description("이메일")
                                                                .type(SimpleType.STRING),
                                                        parameterWithName("gender")
                                                                .description("성별")
